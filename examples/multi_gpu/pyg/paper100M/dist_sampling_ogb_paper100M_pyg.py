...
import time
from quiver_preprocess_ogb import load_preprocessed_quiver
...
from .. import load_preprocessed_quiver
...
if __name__ == '__main__':
    ...
    if LOAD_PREPROCESS:
        ...
        csr_topo, feature = load_preprocessed_feature_and_topo("/data/paper100M")
        quiver_sampler = quiver.pyg.GraphSageSampler(csr_topo, [15, 10, 5], 0, mode="UVA")
        quiver_feature = quiver.Feature(rank=0, device_list=list(range(world_size)), device_cache_size="5G", cache_policy="numa_replicate", csr_topo=csr_topo)
