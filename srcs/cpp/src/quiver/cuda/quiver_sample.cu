...
// TorchQuiver
// new_quiver_from_edge_index_weight(size_t n, py::array_t<int64_t>
// &input_edges,
//                                   py::array_t<int64_t> &input_edge_idx,
...
//                 thrust::make_tuple<int64_t, int64_t, int64_t>(thread_idx,
//                 w_new,
//                                                               j);
//             count++;
//         }
...
//     int threads = 1024;
//     uniform_saintgraph_kernel<<<(idx.numel() + threads - 1) / threads,
//     threads,
//                                 0, stream>>>(
...
//     auto new_end = thrust::remove_if(edges.begin(), edges.end(),
//     is_sampled()); edges.erase(new_end, edges.end());
